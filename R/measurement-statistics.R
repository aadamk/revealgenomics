    ...
    query2 = paste0(
      "equi_join(",
                 ...
                 "project(apply(",
                         ...
                         "study_name, name), study_name, project_id) as r, ",
                "left_names:(l.dataset_id,l.dataset_version),
                 right_names:(r.dataset_id,r.dataset_version), keep_dimensions:false",
      ")"
    )
    query3 = paste0(
      "equi_join(",
                 ...
                 "project(apply(",
                         ...
                         "project_name, name), project_name) as r, ",
                "left_names:l.project_id,
                 right_names:r.project_id,
        ...
        filter(
          equi_join(
            apply(", revealgenomics:::full_arrayname(.ghEnv$meta$arrBiosample),
              "_INFO, dataset_id, dataset_id, dataset_version, dataset_version) as l,
            project(
              apply(
                filter(", revealgenomics:::full_arrayname(.ghEnv$meta$arrBiosample),
                  "_INFO, key='sample_molecule_type'),
                sample_molecule_type, val),
              sample_molecule_type) as r,
          left_names:l.biosample_id,
          right_names:r.biosample_id,
          left_outer:true), ",
        query0,
        "),
      count(*) AS total,
    ...
    query2 = paste0(
      "equi_join(",
                 ...
                 "project(apply(",
                               ...
                               "study_name, name), study_name, project_id) as r, ",
                "left_names:(l.dataset_id, l.dataset_version),
                 right_names:(l.dataset_id, l.dataset_version), keep_dimensions:false",
      ")"
    )
    query3 = paste0(
      "equi_join(",
