        ...
        tryCatch({
          ...
          list(
            left_query = paste0("equi_join(",
                                scanned_array, " as l, ",
                                leftq, " as r, left_names:(l.feature_id,l.dataset_version,l.measurementset_id),
                                right_names:(r.feature_id,r.dataset_version,r.measurementset_id),
                                algorithm:'hash_replicate_right', keep_dimensions:true)"),
