...
get_experiments = function(con = NULL) {
  ...
  qq = paste("equi_join(",
                        ...
                        "filter(", custom_scan(), "(", full_arrayname(.ghEnv$meta$arrDataset), "_INFO), key='", info_key, "') as Y, ",
                        "left_names:(X.dataset_id,X.dataset_version),",
                        "right_names:(Y.dataset_id,Y.dataset_version), left_outer:true)",
             sep = "")
  ...
  qq2 = paste("equi_join(",
                        ...
                        "project(
                                 apply(", custom_scan(), "(", full_arrayname(.ghEnv$meta$arrExperimentSet), "), experimentset_id_, experimentset_id),
                                       experimentset_id_, name) as l, ",
                        "left_names:(l.experimentset_id,l.dataset_version), ",
                        "right_names:(r.experimentset_id,r.dataset_version))")
