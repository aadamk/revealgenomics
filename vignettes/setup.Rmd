...
# When you are logged in as root, but latest package is with user `ksenshar`
USER=ksenshar
cd /home/$USER/coding/downloads/scidb4gh/; R --slave -e "library(roxygen2); roxygenize()" && cd /home/$USER/coding/downloads/ && R CMD build scidb4gh && R CMD INSTALL scidb4gh_0.1.tar.gz
```
