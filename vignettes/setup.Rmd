...
```{sh}
iquery -aq "create_namespace('gh_public')"
iquery -aq "create_namespace('gh_public_rw')"
iquery -aq "create_namespace('gh_secure')"
iquery -aq "create_namespace('permissions')"
```
...
```{sh}
sudo R --slave -e "devtools::install_github('Paradigm4/reveal-genomics')"
```
